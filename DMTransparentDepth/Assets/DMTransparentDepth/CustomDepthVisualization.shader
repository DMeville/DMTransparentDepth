...
Shader "DM/TransparentDepth/Visualization"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float clampDepth8 = SHADERGRAPH_SAMPLE_SCENE_DEPTH( float4( texCoord11, 0.0 , 0.0 ).xy );
				float2 uv_TransparentDepth = IN.ase_texcoord3.xy * _TransparentDepth_ST.xy + _TransparentDepth_ST.zw;
				float3 temp_cast_1 = (max( clampDepth8 , tex2D( _TransparentDepth, uv_TransparentDepth ).r )).xxx;
...
/*ASEBEGIN
Version=18912
1671;73;931;865;1094.017;584.4936;1.3;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-678,-247.5;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ScreenDepthNode;8;-438,-216.5;Inherit;False;1;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;6;-672,-80.5;Inherit;True;Global;_TransparentDepth;_TransparentDepth;0;0;Create;True;0;0;0;False;0;False;-1;None;;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMaxOpNode;12;-289.3999,-103.5;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
