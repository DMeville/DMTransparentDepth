...
Shader "Water"
{
	Properties
	{
		...
		[ASEBegin]_DepthDistance("DepthDistance", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float distanceDepth8 = abs( ( screenDepth8 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthDistance ) );
				float4 lerpResult5 = lerp( _Color0 , _Color1 , saturate( distanceDepth8 ));
...
/*ASEBEGIN
Version=18912
2014;73;1425;865;1235.5;469.5;1;True;False
Node;AmplifyShaderEditor.LerpOp;5;-316.5,-273.5;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;9;-371.5,-41.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;8;-654.5,-19.5;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-857.5,-5.5;Inherit;False;Property;_DepthDistance;DepthDistance;0;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;6;-580.5,-376.5;Inherit;False;Property;_Color0;Color 0;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;7;-581.5,-196.5;Inherit;False;Property;_Color1;Color 1;2;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;11;-437.5,139.5;Inherit;False;Property;_Alpha;Alpha;3;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=44FB0D096473A2A337406D9DB16074061EBA629C